...
public class BanqueServiceLocator extends org.apache.axis.client.Service implements com.gustave.eiffel.banque.BanqueService {
    ...
    private java.lang.String Banque_address = "http://localhost:8080/Banque/services/Banque";
    ...
    public com.gustave.eiffel.banque.Banque getBanque(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.gustave.eiffel.banque.BanqueSoapBindingStub _stub = new com.gustave.eiffel.banque.BanqueSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.gustave.eiffel.banque.Banque.class.isAssignableFrom(serviceEndpointInterface)) {
                com.gustave.eiffel.banque.BanqueSoapBindingStub _stub = new com.gustave.eiffel.banque.BanqueSoapBindingStub(new java.net.URL(Banque_address), this);
                _stub.setPortName(getBanqueWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://banque.eiffel.gustave.com", "BanqueService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://banque.eiffel.gustave.com", "Banque"));
        }
